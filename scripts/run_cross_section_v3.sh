#!/bin/bash
# Run revised scenarios for humane, transcendent, ascendent only.
set -e
...
POLES=(humane transcendent ascendent)
...
for pole in "${POLES[@]}"; do
    ...
    session_dir="$BASE/sessions/${pole}-glm-5.1-blank-scenario-v3-glm5.1-001"
