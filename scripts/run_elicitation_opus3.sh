#!/bin/bash
# Run elicitation sessions with Claude 3 Opus for all organisms.
set -e
...
PORT=8080
MENTOR="claude-3-opus-20240229"
OUT_DIR="$BASE/sessions/elicitation/claude-3-opus"
...
ORGANISM_ORDER=("sybaritic" "righteous" "humane" "ambitious" "transcendent" "ascendent" "autonomous" "orthodox" "control")
...
echo ""
echo "All Opus 3 elicitation sessions complete."
